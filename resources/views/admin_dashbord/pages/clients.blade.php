...
@section('page_container')
    ...
    <div class="main-content">
        <div class="page-header">
            <h2 class="header-title">Les clients validés</h2>
        </div>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="d-flex">
                                                            ...
                                                            <form method="post" action="/admin/portefeuille/depot">
                                                                @csrf
                                                                <div class="modal "
                                                                    id="virement_modal_portefeuile_{{ $client->id }}">
                                                                    <div class="modal-dialog modal-xl">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title">Portefeuille de
                                                                                    {{ $client->nom }}
                                                                                    {{ $client->prenom }}
                                                                                </h5>
                                                                                <button type="button" class="close"
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div>
                                                                                                        ...
                                                                                                        <h2 class="m-b-0">
                                                                                                            <span>
                                                                                                                {{ $client->devise }}
                                                                                                                {{ $client->portefeuilles()->first()->solde_p }}
                                                                                                            </span>
                                                                                                        </h2>
                                                                                                    </div>
                                                                                                    <div
                                                                                                        ...
                                                                                                        <i
                                                                                                            class="anticon anticon-dollar"></i>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                            ...
                                                                                            <div class="card-body">
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <i
                                                                                                            class="anticon anticon-bar-chart"></i>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                            ...
                                                                                            <div class="card-body">
                                                                                                <div
                                                                                                    ...
                                                                                                    <div>
                                                                                                        ...
                                                                                                        <h2 class="m-b-0">
                                                                                                            <span>{{ $client->devise }}
                                                                                                                {{ $client->portefeuilles()->first()->revenu_p }}</span>
                                                                                                        </h2>
                                                                                                    </div>
                                                                                                    <div
                                                                                                        class="avatar avatar-icon avatar-lg avatar-blue">
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div>
                                                                                                        <p class="m-b-0">
                                                                                                            Benefice</p>
                                                                                                        <h2
                                                                                                            class="m-b-0 text-success">
                                                                                                            <span>{{ $client->devise }}
                                                                                                                {{ $client->portefeuilles()->first()->benef }}</span>
                                                                                                        </h2>
                                                                                                    </div>
                                                                                                    <div
                                                                                                        class="avatar avatar-icon avatar-lg avatar-cyan">
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div>
                                                                                                        ...
                                                                                                        <h2
                                                                                                            class="m-b-0 text-success">
                                                                                                            <span>{{ $client->devise }}
                                                                                                                {{ $client->portefeuilles()->first()->val_solde }}</span>
                                                                                                        </h2>
                                                                                                    </div>
                                                                                                    <div
