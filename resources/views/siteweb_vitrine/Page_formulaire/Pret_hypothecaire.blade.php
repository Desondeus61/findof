    ...
    <div class="container">
        ...
        <div>
            <p>Nous sommes fiers de proposer un prêt hypothécaire qui vous permet d'acquérir un logement ou de refinancer votre prêt immobilier existant. Voici plus de détails sur les conditions et les avantages de notre prêt hypothécaire :
                ...
                - Accompagnement personnalisé : Chez {{ config('app.app_name') }}, nous mettons un point d'honneur à vous offrir un accompagnement personnalisé tout au long du processus. Nos experts en prêt hypothécaire sont là pour répondre à vos questions, évaluer votre situation et vous guider dans le choix de la meilleure option de financement.
        ...
        <div class="col-6 col-md-8">
            <ul class="list-inline m-0">
              <li class="py-2 border-top border-bottom">
                <i class="fa fa-check text-primary mr-3"></i>Emprunter juqu'à 125% du prix d'achat d'un bien immobilier chez {{ config('app.app_name') }}
              </li>
