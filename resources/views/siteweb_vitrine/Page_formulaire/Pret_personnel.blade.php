...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <div>
            <p>Chez {{ config('app.app_name') }}, nous proposons un prêt personnel polyvalent pour répondre à vos différents besoins financiers. Que ce soit pour faire face à des dépenses imprévues, réaliser un voyage de rêve, effectuer des rénovations dans votre maison ou financer tout autre projet personnel, notre prêt personnel est conçu pour vous offrir la flexibilité nécessaire.
