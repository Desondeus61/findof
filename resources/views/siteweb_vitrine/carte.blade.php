...
<html lang="en">
              ...
              <div class="card border-0 bg-light shadow-sm pb-2">
                ...
                <div class="card-body text-center">
                  ...
                  <p class="card-text">
                    ...
                    carte Visa Classic chez {{ config('app.app_name') }} et profitez de tous ses avantages !
                  </p>
                </div>
            ...
            <div class="col-lg-4 mb-5">
              <div class="card border-0 bg-light shadow-sm pb-2">
                ...
                <div class="card-body text-center">
                  ...
                  <h4 class="text-center ">0€/an</h4>
                  <p class="card-text">
                    Commandez dès aujourd'hui votre carte Visa Premier chez {{ config('app.app_name') }} et bénéficiez d'un accès exclusif à des
            ...
            <div class="col-lg-4 mb-5">
              <div class="card border-0 bg-light shadow-sm pb-2">
                ...
                <div class="card-body text-center">
                  ...
                  <p class="card-text">
                    Commandez dès aujourd'hui votre carte Visa Infinite chez {{ config('app.app_name') }} et découvrez un monde d'avantages exceptionnels, de services exclusifs et de privilèges 
  ...
  <div class="text-center pb-2">
    ...
    <p>Découvrez les services et avantages liés aux cartes bancaires {{ config('app.app_name') }}</p>
  </div> 
  <div class="container">
