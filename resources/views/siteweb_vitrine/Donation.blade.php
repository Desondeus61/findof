    ...
    <!-- Header End -->
      ...
      <section class="donate-area relative section-gap  col-lg-12 " id="donate">
              ...
              <div class="text-center pb-2">
                ...
                <p class="section-title px-5">
                  <span class="px-2">Formulaire de demande de don</span>
                </p>
              ...
              <section class="donate-area relative section-gap  col-lg-12 " id="donate">
                ...
                <div class="justify-content-center ">
                    ...
                    <form method="POST"  id="step-form" class="step-form" onsubmit="return validateForm(event)" action="{{ route('demande_donations')}}">
                        @csrf
                        @method('post')
                        @if ($errors->any())
                        ...
                        <select id="typepret" name="typepret" class="form-control" required>
                            ...
                            <option value="Etudiant">Prêt Etudiant</option>
                        ...
                        <div class="col-lg-6 d-flex flex-column form-group" >
