      ...
      <div class="row align-items-center px-3 ">
        <div class="col-lg-6 text-center text-lg-left" style="margin-top:100px;">
          ...
          <div class="display-3 font-weight-bold text-white">
             <span class="one_text one_first " style="color: #249DD5"> <span style="color: #F49122"> FindOP </span> Bank <span style="color:  #F49122">!</span> </span>
    ...
    <div class="container-fluid">
      ...
      <div class="d-flex flex-column align-items-center justify-content-center">
        <div class=" d-none d-md-flex d-sm-flex font-weight-bold text-white mb-2">
          <span class="one_text one_first " style=" font-size:22px;"> <span style="color: #F49122"> FindOP- </span> </span>
       ...
       <div class=" d-md-none d-sm-none  display-3 font-weight-bold text-white mb-2">
        <span class="one_text one_first " style=" font-size:14px;"> <span style="color: #F49122">ELITE-MONETIX </span> </span>
      ...
      <div class="container-fluid mt-2">
        ...
        <div class="d-flex flex-column align-items-center justify-content-center">
          <div class=" d-none d-md-flex d-sm-flex font-weight-bold text-white mb-2">
            ...
            <span class="one_text second_text" style="color: #249DD5;font-size:22px;"> <span style="font-size:1px;margin-left:3px;"> °</span> cartes bancaires FindOP <img src="site_web/img/lg/coeur.png" alt=""></span>

         </div>
         <div class=" d-md-none d-sm-none  display-3 font-weight-bold text-white mb-2">
          <span class="one_text one_first " style=" font-size:14px;"> <<span style="color: #F49122">Découvrez vos  </span> </span>
          <span class="one_text second_text" style="color: #249DD5;font-size:14px;"> <span style="font-size:1px;margin-left:2px;">°</span> cartes bancaires FindOP </span>
           ...
           <div class="col-md-6">
            ...
            <div class=" col-md-6 flex-column  justify-content-center">
             ...
             <div class="d-flex ">
              ...
              <p>ELITE-MONETIX offre une prime de bienvenue allant jusqu'à 110 euros à ses nouveaux clients pour l'ouverture d'un <a href="/register">compte bancaire en ligne</a></p>
        <p class="d-none d-md-flex d-sm-flex">ELITE-MONETIX propose 3 offres de compte bancaire avec carte Visa, dont deux gratuites. La gestion se fait entièrement à distance, par internet ou applications sur mobile. La banque en ligne se revendique depuis plus d'une dizaine d'années être la « banque la moins chère ».
            ...
            <div class=" col-md-6 flex-column  justify-content-center">
              <div class="d-flex flex-column ">
                ...
                <p class="d-none d-md-flex d-sm-flex">
                  Assurez votre tranquillité financière en saisissant dès aujourd'hui une opportunité d'investissement chez FindOP Bank. Notre plateforme vous propose un revenu mensuel sécurisé, générant un rendement exceptionnel de 17% sur votre investissement. Vous pourrez ainsi consolider votre patrimoine tout
                  en bénéficiant d'une carte de retrait spéciale qui simplifiera vos transactions financières.
                  Faites confiance à FindOP Bank pour vous accompagner vers un avenir financier prospère et serein.
                ...
                <p class=" d-md-none d-sm-none">Protégez votre avenir financier en investissant dès aujourd'hui chez FindOP Bank. Bénéficiez d'un revenu mensuel garanti de 17% sur votre investissement,
            ...
            >
              ...
              <div class="">
                ...
                <p class="m-0">
                    ...
                    Faites le choix dès maintenant de l'Assurance Scolaire FindOP
              ...
              <div class="">
                ...
                <p class="m-0">
                    Ne perdez pas une minute de plus !
                     Ouvrez votre compte bancaire chez {{ config('app.app_name') }} dès maintenant et
          ...
          <div class="col-lg-4 col-md-6 pb-1 d-none d-md-flex d-sm-flex">
            ...
            >
              ...
              <div class="">
                ...
                <p class="m-0">
                    Pratique, gratuite et idéale pour les paiements du quotidien, commandez dès maintenant vos cartes FindOP. Profitez d'une expérience de paiement sans tracas avec nos cartes, acceptées partout.
                     Simplifiez vos transactions avec FindOP.
                </p>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-7">
            ...
            <p>
                Chez FindOP, nous mettons un point d'honneur à protéger vos finances.
                 ...
                 emprunts financiers. Nous comprenons l'importance de la disponibilité des fonds,
                  ...
                  FindOP pour vous accompagner vers un avenir financier plus prometteur.
            </p>
    ...
    <div class="container-fluid pt-5">
      <div class="container">
        <div class="text-center pb-2">
          ...
          <h1 class="mb-4">Heureux, ils nous ont recommandés et ont décidé de témoigner, {{ config('app.app_name') }} les remercie à nouveau.</h1>
        </div>
        <div class="row">
        ...
        <div class="d-flex flex-wrap">
          ...
          <div>
            ...
            <p class="">
              ...
              FindOP Bank s'engage à vous offrir le meilleur.
