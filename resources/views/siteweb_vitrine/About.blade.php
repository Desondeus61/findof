...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>{{ config('app.app_name') }} About us</title>
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-lg-7">
              ...
              <h1 class="mb-4">Nous sommes {{ config('app.app_name') }}</h1>
              <p>
          ...
          <div class="col-lg-4 col-md-6 pb-1">
            ...
            >
              ...
              <div class="pl-4">
                ...
                <p class="m-0">
                  {{ config('app.app_name') }} dispose d'une équipe d'experts financiers hautement qualifiés et expérimentés, capables de fournir des conseils et des solutions 
          ...
          <div class="col-lg-4 col-md-6 pb-1">
            ...
            >
              ...
              <div class="pl-4">
                ...
                <p class="m-0">
                  {{ config('app.app_name') }} propose une large gamme de services financiers, notamment des prêts, des investissements, 
          ...
          <div class="col-lg-4 col-md-6 pb-1">
            ...
            >
              ...
              <div class="pl-4">
                ...
                <p class="m-0">
                  {{ config('app.app_name') }} accorde une grande importance à la compréhension des besoins spécifiques de chaque client et propose
          ...
          <div class="col-lg-4 col-md-6 pb-1">
            ...
            >
              ...
              <div class="pl-4">
                ...
                <p class="m-0">
                  {{ config('app.app_name') }} s'efforce d'offrir des taux d'intérêt compétitifs sur ses produits et services 
          ...
          <div class="col-lg-4 col-md-6 pb-1">
            ...
            >
              ...
              <div class="pl-4">
                ...
                <p class="m-0">
                  {{ config('app.app_name') }} met l'accent sur la satisfaction de ses clients en offrant un service clientèle réactif, amical et professionnel. Ils sont
          ...
          <div class="col-lg-4 col-md-6 pb-1">
            ...
            >
              ...
              <div class="pl-4">
                <h4>Transparence</h4>
                <p class="m-0">
                  {{ config('app.app_name') }} prône la transparence dans ses opérations financières. Ils s'engagent à fournir à leurs clients des informations
