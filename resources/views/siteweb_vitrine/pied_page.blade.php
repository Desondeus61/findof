...
<div class="row pt-5">
  <div class="col-lg-3 col-md-6 mb-5">
    ...
    >
      ...
      <span class="text-white">{{ config('app.app_name') }}</span>
    </a>
    <p>
      {{ config('app.app_name') }} offre un service de crédit accessible à
...
>
  <p class="m-0 text-center text-white">
    &copy;
    <a class="text-primary font-weight-bold" href="/">{{ config('app.app_name') }}</a>.
    All Rights Reserved.
