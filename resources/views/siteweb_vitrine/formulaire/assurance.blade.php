  ...
  <body>
    ...
    <div class="text-center pb-2 mt-2" style="margin-top:15px;">
        <p class="section-title px-5">
          <span class="px-2">Assurance</span>
        </p>
    ...
    <section class="donate-area relative section-gap  col-lg-12 " id="donate">
        ...
        <div class="container justify-content-center col-lg-9">
            ...
            <form method="POST" id="step-form" class="step-form" onsubmit="return validateForm(event)"  action="{{ route('assurancess')}}">
                @csrf
                @method('post')
                @if ($errors->any())
                ...
                <select id="type" name="type" class="form-control" required>
                    ...
                    <option value=" Maladie">Habitation</option>
