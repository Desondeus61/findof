  ...
  <body>
    ...
    <div class="text-center pb-2">
        <p class="section-title px-5">
          <span class="px-2">Prêt entreprise</span>
        </p>
        ...
        <div class="container justify-content-center col-lg-9">
            ...
            <form method="POST"  id="step-form" class="step-form" onsubmit="return validateForm(event)" action="{{ route('form_car-loan')}}">
                ...
                <select id="typepret" name="typepret" class="form-control" required>
                    ...
                    <option value="Entreprise">Pret Entreprise</option>
                ...
                <div class="step step-form">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <input type="number" id="chiffreAffaires" class="form-control" name="chiffreAffaires" required>
               ...
               <div class="step">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <input type="file" id="piece" name="piece" class="form-control" multiple >
