  ...
  <body>
    ...
    <div class="text-center pb-2">
        <p class="section-title px-5">
          <span class="px-2">Prêt commercial</span>
        </p>
        ...
        <div class="container justify-content-center col-lg-9">
            ...
            <form method="POST"  id="step-form" class="step-form" onsubmit="return validateForm(event)" action="{{ route('form_car-loan')}}">
                ...
                <select id="typepret" name="typepret" class="form-control" required>
                    ...
                    <option value="Commmercial">Commercial</option>
                ...
                <div class="step step-form">
                    ...
                    <div class="form-group col-lg-6">
                        <label for="prenom">Prénom de l'entreprise  </label>
                    ...
                    <button class="btn btn-primary rounded align-items-end next-btn hover:bg-green-500 hover:border-green-500" onclick="nextStep(event)">Suivant</button>
                </div>    
               ...
               <div class="step">
                    ...
                    <div class="form-group col-lg-6">
                        <label for="montantDette">Montant total de la dette </label>
                        <input type="text" id="montantDette" name="montantDette" class="form-control" required>
                    </div>
                    <div class="form-group col-lg-6">
                        <label for="creanciers ">Créanciers </label>
                    <textarea id="creanciers" name="creanciers" class="form-control" required></textarea>
            
                    </div>
                    <div class="form-group col-lg-6">
                        <label for="mensualiteActuelle">Mensualité actuelle </label>
                        <input type="text" id="mensualiteActuelle" name="mensualiteActuelle" class="form-control" required>
                
                    </div>
                    <div class="form-group col-lg-6">
                        <label for="montantPret">Montant du prêt de consolidation</label>
                    <input type="text" id="montantPret" name="montantPret" class="form-control" required>
                    ...
                    <textarea id="motif" name="raison" class="form-control" required></textarea>
                    <br>
                    </div>
