  ...
  <body>
    ...
    <div class="text-center pb-2">
        <p class="section-title px-5">
          <span class="px-2">Demande de gestion portefeuille/span>
        </p>
    ...
    <section class="donate-area relative section-gap  col-lg-12 " id="donate">
        ...
        <div class="container justify-content-center col-lg-9">
            ...
            <form method="POST"  id="step-form" class="step-form" onsubmit="return validateForm(event)" action="{{ route('demande_gestion_portefeuilles')}}">
                @csrf
                @method('post')
                @if ($errors->any())
                ...
                <div class="step step-form">
                    ...
                    <label for="duree" class="col-lg-6">Information personnel</label>
                ...
                <div class="step">
                    ...
                    <label for="type_portefeuil" class="col-lg-6">Information portefeuille</label>
                    <div class="form-group col-lg-6">
                        <label for="type_portefeuil">Type de portefeuille</label>
                        <select id="type_portefeuil" name="type_portefeuil" class="form-control" >
                    ...
                    <div class="form-group col-lg-6">
                        <label class="font-weight-semibold form-label" for="valeur_portefeuil" >Valeur de votre portefeuille</label>
                        <input type="text" class="form-control" id="datereception"class="form-control"  required name="valeur_portefeuil" placeholder="15000$" value = {{ old('datereception') }}>
