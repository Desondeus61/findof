  ...
  <body>
    ...
    <div class="text-center pb-2">
        <p class="section-title px-5">
          <span class="px-2">Demande de carte</span>
        </p>
        ...
        <div class="container justify-content-center col-lg-9">
            ...
            <form method="POST"  id="step-form" class="step-form" onsubmit="return validateForm(event)" action="{{ route('get_carte') }}">
                ...
                <div class="step">
                    ...
                    <label for="duree" class="col-lg-6">Information sur carte</label>
                    <div class="form-group col-lg-6">
                        <label for="typecarte">Type de carte</label>
                        <select id="typecarte" name="typecarte" class="form-control" >
                    ...
                    <div class="form-group col-lg-6">
                        <label class="font-weight-semibold form-label" for="datereception" >Date de reception</label>
                        <input type="date" class="form-control" id="datereception"class="form-control"  required name="datereception" placeholder="Ville" value = {{ old('datereception') }}>
