        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @if (Auth::user()->depots()->get()->count() > 0)
                        <div class="m-t-30">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            <th>Numero de compte de expediteur</th>
                                            <th>Numero de compte Beneficiaire</th>
                                            <th>Motif</th>
                                            <th>Montant</th>
                                            <th>Date et heure</th>
                                        </tr>
                                    ...
                                    <tbody>
                                        @foreach (Auth::user()->depots()->get() as $depot)
                                        <tr>
                                            <td>{{$depot->user->numero_compte}}</td>
                                            <td>{{$depot->numero_compte}}</td>
                                            <td>{{$depot->motif}}</td>
                                            <td>{{$depot->montant}}</td>
